...
public class ChatUtils {
    ...
    public GptVisionModel conversionStructureToVision(final GptVisionWebDto dto) {
        return new GptVisionModel().setMessages(dto.getMessages());
    }
...
//        messages.add(0, new GptModel.Messages().setRole("user").setContent("说中文"));
//        messages.add(1, new GptModel.Messages().setRole("system").setContent(""));
        return messages;
    }
