...
public class UserController {
     ...
     * @return the result
     */
    @PostMapping(value = "/star_preset/put/data", name = "添加/删除收藏_预设", produces = MediaType.APPLICATION_JSON_VALUE)
    public Result putStarPreset(@RequestBody @Validated final StarPresetDto dto) {
        return Result.data(starService.starPreset(dto));
    }
     ...
     * @return the result
     */
    @GetMapping(value = "/star_preset/get/web", name = "获取我的收藏_预设", produces = MediaType.APPLICATION_JSON_VALUE)
    public Result getUserStarPresetWeb() {
        return Result.data(starService.getUserStarPresetWeb());
    }
}
