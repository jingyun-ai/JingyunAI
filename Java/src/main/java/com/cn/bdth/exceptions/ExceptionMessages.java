...
public interface ExceptionMessages {
    ...
    String PHONE_LOGIN_PWD_ERR = "手机号或密码错误";

    String ACCOUNT_ALREADY_EXISTS_ERR = "该账号已存在";

    String EMAIL_NOT_EXIST = "该邮箱不存在";
    String PHONE_NOT_EXIST = "该手机号不存在";
    String CODE_ERR = "验证码已过期或错误";
    String NOT_EXIST_CODE = "兑换码不存在或已失效";

    String VERIFICATION_CODE_ERR = "生成验证码失败/请勿频繁发送短信";
    ...
    String GPT_FREQUENT = "余额不足,请观看小程序广告获得奖励";
