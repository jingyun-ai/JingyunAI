...
public class UserServiceImpl implements UserService {
    ...
    public UserInfoVo getCurrentUserInfo() {
        ...
        if (chatGptStructure != null) {
            userInfoVo.setGptPlusFrequency(chatGptStructure.getGptPlusFrequency());
            userInfoVo.setGptFrequency(chatGptStructure.getGptFrequency());
        }
        return userInfoVo;
    }
    ...
    public IPage<UserDataVo> getUserPageVo(final int pageNum, final String prompt) {
        return userMapper.selectPage(new Page<>(pageNum, 15), new QueryWrapper<User>()
                ...
                .select(User::getFrequency, User::getUserName, User::getCreatedTime, User::getUserId, User::getEmail, User::getPhone)
