...
public class ServerServiceImpl implements ServerService {
    ...
    public void heavyLoadDisposition(final ServerConfigDto dto) {
        ...
        //DrawingSimple
        redisUtils.setValue(ServerConstant.DRAWINGSIMPLE_CONFIG,
                new DrawingSimpleCommon.DrawingSimpleStructure()
                        .setDebug(dto.getDrawingSimpleDebug())
                        .setCcoUrl(dto.getCcoUrl())
                        .setCcoImgFrequency(dto.getCcoImgFrequency())
                        .setCcoGPTFrequency(dto.getCcoGPTFrequency())
                        .setCcoSamFrequency(dto.getCcoSamFrequency())
                        .setTuKeLi_Url(dto.getTuKeLi_Url())
                        .setTuKeLi_Key(dto.getTuKeLi_Key())
                        .setTkloutPaintGenerateFrequency(dto.getTkloutPaintGenerateFrequency())
                        .setTklpromeaigenerateFrequency(dto.getTklpromeaigenerateFrequency())
                        .setTklsupermodelGenerateFrequency(dto.getTklsupermodelGenerateFrequency())
        );
    }
    ...
    public DispositionVo getDisposition() {
        ...
        final DrawingSimpleCommon.DrawingSimpleStructure drawingSimpleStructure = (DrawingSimpleCommon.DrawingSimpleStructure) redisUtils.getValue(ServerConstant.DRAWINGSIMPLE_CONFIG);
        ...
        dispositionVo.setDrawingSimpleDebug(drawingSimpleStructure != null ? drawingSimpleStructure.getDebug() : null);
        dispositionVo.setCcoUrl(drawingSimpleStructure != null ? drawingSimpleStructure.getCcoUrl() : null);
        dispositionVo.setCcoImgFrequency(drawingSimpleStructure != null ? drawingSimpleStructure.getCcoImgFrequency() : null);
        dispositionVo.setCcoGPTFrequency(drawingSimpleStructure != null ? drawingSimpleStructure.getCcoGPTFrequency() : null);
        dispositionVo.setCcoSamFrequency(drawingSimpleStructure != null ? drawingSimpleStructure.getCcoSamFrequency() : null);
        dispositionVo.setTuKeLi_Url(drawingSimpleStructure != null ? drawingSimpleStructure.getTuKeLi_Url() : null);
        dispositionVo.setTuKeLi_Key(drawingSimpleStructure != null ? drawingSimpleStructure.getTuKeLi_Key() : null);
        dispositionVo.setTkloutPaintGenerateFrequency(drawingSimpleStructure != null ? drawingSimpleStructure.getTkloutPaintGenerateFrequency() : null);
        dispositionVo.setTklpromeaigenerateFrequency(drawingSimpleStructure != null ? drawingSimpleStructure.getTklpromeaigenerateFrequency() : null);
        dispositionVo.setTklsupermodelGenerateFrequency(drawingSimpleStructure != null ? drawingSimpleStructure.getTklsupermodelGenerateFrequency() : null);
