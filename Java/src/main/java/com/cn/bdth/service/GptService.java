...
public interface GptService {
    ...
    //自定义模型
    Flux<String> concatenationDiyGpt(GptModel model, String modelName, final boolean isAdvanced, ChatGptCommon.ChatGptStructure chatGptStructure);

    //GPT识图模型
    Flux<String> concatenationVisionGpt(GptVisionModel gptVisionModel, String modelName, boolean isAdvanced, ChatGptCommon.ChatGptStructure chatGptStructure);

    //直连fastgpt
    Flux<String> concatenationFastGpt(GptModel model, String modelName, ChatGptCommon.ChatGptStructure chatGptStructure);
