...
public class DrawingServiceImpl implements DrawingService {
    ...
    public DrawingTaskVo publishSdTask(final DrawingSdTaskDto dto) {
        ...
        if (dto.getImages() != null) {
            ...
            if (dto.getMask() != null) {
                final String maskUrl = aliUploadUtils.uploadFile(dto.getMask(), FileEnum.PAINTING.getDec(), null, true);
                model.setMask(List.of(imageUtils.convertImageToBase64(maskUrl)));
            }
            //检查是否为黄图
            try {
